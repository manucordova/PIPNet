...
data_pars = dict(
                 ...
                 lw = [[2e1, 2e2], [1e2, 1e3]], # Linewidth range for Gaussians
                 iso_p = [0.9, 0.1],
                 iso_p_peakwise = True,
                 ...
                 nmax = 8, # Maximum number of peaks
                 shift_range = [1000., 5000.], # Chemical shift range
                 ...
                 iso_norm = 128., # Normalization factor for peaks
                 brd_norm = 32., # Normalization factor for MAS spectra
...
train_pars = dict(batch_size = 16, # Dataset batch size
                  ...
                  out_dir = "../data/Ensemble_PIPNet_2021_11_29_4k/", # Output directory
                  change_factor = {25: 0.}, # Checkpoints where
                  avg_models = False,
