...
data_pars = dict(
                 ...
                 mas2_m_range=[[0., 10], [1e4, 1e6]],
                 mas2_m_p=[0.5, 0.5],
                 # Second-order MAS-dependent shift range
                 mas2_s_range=[[0., 0.], [-2e11, 2e11]],
                 mas2_s_p=[0.8, 0.2],
...
train_pars = dict(batch_size=16,  # Dataset batch size
                  ...
                  out_dir="../data/Ensemble_PIPNet_2022_05_03_prod_16/",  # Output directory
...
opt = torch.optim.Adam(net.parameters(), lr=1e-4, betas=(0.9,
